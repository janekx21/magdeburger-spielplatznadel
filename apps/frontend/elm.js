...
var $author$project$Main$saveCapture = F2(
	function (appOnline, capture) {
		return $author$project$Main$pouchDB(capture);
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'CreateCapture':
				return _Utils_Tuple2(
					model,
					A2($author$project$Main$saveCapture, model.online, model.capture));
...
var $author$project$Main$grayLight = A3($mdgriffith$elm_ui$Element$rgb255, 224, 231, 236);
...
var $author$project$Main$placeholder = A2(
	$mdgriffith$elm_ui$Element$el,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Border$rounded(16),
			$mdgriffith$elm_ui$Element$Background$color($author$project$Main$grayLight),
		...
		body: _List_fromArray(
			[
				...
				A2(
					...
					_List_fromArray(
						[$author$project$Main$placeholder, $author$project$Main$placeholder])))
			]),
		title: 'DWYL App'
	};
};
